<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="CredExtraordinario" Title="Credito Extraordinario" Codebehind="CredExtraordinario.aspx.cs" %>
    ...
    GridLines="None" Width="100%">
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="iColocacion,NombreProducto,cAmortizacion" 
                DataNavigateUrlFormatString="CredExtraordinario2.aspx?IColocacion={0}&amp;op=7&amp;Nommbre={1}&amp;cAmortizacion={2}" 
